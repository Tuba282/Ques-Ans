...
const AdminSettings = ({ updateUser, updateImage, handleUserSettingsChange, handleImageChange, handleUpdateProfile, handleLogout, currentUser }) => (
  <form className="space-y-8 container m-auto divide-y divide-gray-200 p-10" onSubmit={handleUpdateProfile}>
    ...
    <div className="pt-5">
      <div className="flex justify-end">
        <button type="button" onClick={handleLogout} className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Log Out</button>
        <button type="submit" className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Save Updates</button>
      </div>
    </div>
  </form>
);
